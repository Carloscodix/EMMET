...
algorithm on the resulting graph. LASP~\cite{cohen2014lasp}
...
behavior under stationary arrivals. Distance-aware
variants~\cite{stolyar2005maximizing} blend backpressure with
shortest-path bias to mitigate the well-known last-mile
inefficiency of pure backpressure.
