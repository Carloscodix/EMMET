...
Second, the equivalence margin $\delta=2$pp is a generous modelling choice, made operational rather than arbitrary: two percentage points of sustained drop rate is roughly the coarsest difference a capacity planner would treat as materially different service, and smaller gaps are routinely absorbed by provisioning headroom;
