...
analogy: the physical motivation is heuristic, not foundational.
...
\item \emph{Effective mass.} A particle that has been buffeted
through a turbulent region accumulates inertia: it becomes
``costlier to push.'' Translating this to routing: a packet
...
this paper we use $\alpha=1$, $\beta=1.5$, $\gamma=2$,
