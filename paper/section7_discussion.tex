...
EMMET-DP is a controller-level routing algorithm. It assumes
access to global topology and to per-edge state, makes a single
routing decision per packet at admission, and emits a fixed
forwarding path. This places it in the same architectural family
