...
Algorithm~\ref{alg:massaware-dp} per routing decision (one
...
\begin{table}[h]
\centering
\caption{Per-operation cost of Algorithm~\ref{alg:massaware-dp}.
...
\S\ref{subsec:protocol-implications}), this overhead is
...
acceleration directions discussed in \S\ref{subsec:future-work}.
...
suspicion \#6 (\S\ref{sec:experiments}, \texttt{docs/AUDIT\_LOG.md})
