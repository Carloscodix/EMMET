...
An equivalence verdict means nothing without stating the margin, and a margin of
$\delta = 2$ percentage points of drop rate is generous when many of the drop
rates in Table~\ref{tab:equivalence} sit between $0$ and $2\%$. We therefore
re-ran TOST at progressively stricter margins for all three cores. Table~%
