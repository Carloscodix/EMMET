...
# M_MAX/ALPHA_BUDGET live in emmet_momentum_dp (momentum_clean was a
# re-exporter, now archived). The ripple runner below DOES use them, so
# they must resolve to real values, not None.
